<!-- Libs JS -->
<script src="{{ URL::asset('../backend/assets/dist/libs/apexcharts/dist/apexcharts.min.js?1684106062')}}" defer>
</script>
<script src="{{ URL::asset('../backend/assets/dist/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062')}}" defer>
</script>
<script src="{{ URL::asset('../backend/assets/dist/libs/jsvectormap/dist/maps/world.js?1684106062')}}" defer>
</script>
<script src="{{ URL::asset('../backend/assets/dist/libs/jsvectormap/dist/maps/world-merc.js?1684106062')}}" defer>
</script>
